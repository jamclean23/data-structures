...
// Add a node containing a value to the beginning of the list with DataManager.prepend(value)

// DataManager.size() returns the total number of nodes

// DataManager.head() returns the first node on the list

// DataManager.tail() returns the last node on the list

// DataManager.at(index) returns the node at the given index

// DataManager.pop() removes the last element from the list

// DataManager.contains(value) returns true if the given value is in the list, false if not

// DataManager.find(value) returns the index of the value if it's in the list, or null if it is not

// DataManager.toString() returns the entire list in string format
